...
fig_idh_freq.add_trace(go.Scatter(df, x='t_fbfund', y='idhm'), row=1, col=1)
fig_idh_freq.add_trace(go.Scatter(df, x='t_fbmed', y='idhm'), row=1, col=2)
fig_idh_freq.add_trace(go.Scatter(df, x='t_fbsuper', y='idhm'), row=1, col=3)
