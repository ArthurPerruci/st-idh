...
fig_idh_freq.add_trace(go.scatter(x=df['t_fbfund'], y=df['idhm']), row=1, col=1)
fig_idh_freq.add_trace(go.scatter(x=df['t_fbmed'], y=df['idhm']), row=1, col=2)
fig_idh_freq.add_trace(go.scatter(x=df['t_fbsuper'], y=df['idhm']), row=1, col=3)
