...
fig_idh_comp = make_subplots(rows=2, cols=2)
...
fig_idh_comp.add_trace(go.Scatter(x=df['t_med18m'], y=df['idhm'], mode="markers", name="população de 18 anos ou mais  com ensino médio completo"), row=1, col=2)
fig_idh_comp.add_trace(go.Scatter(x=df['t_med25m'], y=df['idhm'], mode="markers", name="população de 25 anos ou mais com ensino médio completo"), row=2, col=1)
fig_idh_comp.add_trace(go.Scatter(x=df['t_super25m'], y=df['idhm'], mode="markers", name="população de 25 anos ou mais com ensino supeior completo"), row=2, col=2)
fig_idh_comp.update_xaxes(title_text="% da população com ensino completo", row=2, col=1)
