...
fig_idh_e_anosestudo.add_trace(go.Scatter(x=df['e_anosestudo'], y=df['idhm'], groupnorm=df['regiao'], mode="markers"))
fig_idh_e_anosestudo.update_xaxaes(title_text="Expectativa de anos de estudo")
...
fig_idh_freq.add_trace(go.Scatter(x=df['t_flfund'], y=df['idhm'], mode="markers", name="Ensino Fundamental"))
fig_idh_freq.add_trace(go.Scatter(x=df['t_flmed'], y=df['idhm'], mode="markers", name="Ensino Médio"))
fig_idh_freq.add_trace(go.Scatter(x=df['t_flsuper'], y=df['idhm'], mode="markers", name="Ensino Superior"))
...
fig_idh_comp.add_trace(go.Scatter(x=df['t_fund18m'], y=df['idhm'], mode="markers", name="população de 18 anos ou mais com ensino fundamental completo"))
fig_idh_comp.add_trace(go.Scatter(x=df['t_med18m'], y=df['idhm'], mode="markers", name="população de 18 anos ou mais  com ensino médio completo"))
fig_idh_comp.add_trace(go.Scatter(x=df['t_med25m'], y=df['idhm'], mode="markers", name="população de 25 anos ou mais com ensino médio completo"))
fig_idh_comp.add_trace(go.Scatter(x=df['t_super25m'], y=df['idhm'], mode="markers", name="população de 25 anos ou mais com ensino supeior completo"))
...
fig_idh_nao_atraso.add_trace(go.Scatter(x=df['t_atraso_0_fund'], y=df['idhm'], mode="markers", name="população de 6 a 14 anos no ensino fundamental sem atraso"))
fig_idh_nao_atraso.add_trace(go.Scatter(x=df['t_atraso_0_med'], y=df['idhm'], mode="markers", name="população de 15 a 17 anos no ensino médio sem atraso"))
