...
fig_idh_freq.update_layout(legend=dict(x=0, y=1.5))
...
fig_idh_comp.update_layout(legend=dict(x=0, y=1.5))
...
fig_idh_nao_atraso.update_layout(legend=dict(x=0, y=1.5))
